...
用不同学科视角审查同一个问题，避免只靠单一工程、商业或情绪视角下判断。

**写作增强**

用文学、历史、哲学和批评视角提升表达、叙事、论证和审美。中文场景可使用曹雪芹、司马迁、苏轼、韩愈和鲁迅等叙事工具。

**决策增强**

哲学看价值，历史看周期，数学看结构，物理看约束，工程看落地。

**快速装配**

给 Codex、Claude Code、OpenCode、Antigravity、Hermes、OpenClaw 直接提供 persona、team、debate 和模板。

...
| 能力 | 价值 |
| --- | --- |
| 思考 | 用不同学科视角审查同一个问题，避免只靠单一工程、商业或情绪视角判断。 |
| 写作 | 提升表达、叙事、论证和审美；中文场景可使用曹雪芹、司马迁、苏轼、韩愈、鲁迅等叙事工具。 |
| 决策 | 哲学看价值，历史看周期，数学看结构，物理看约束，工程看落地。 |
| 装配 | 给 Codex、Claude Code、OpenCode、Antigravity、Hermes、OpenClaw 提供 persona、team、debate 和模板。 |
